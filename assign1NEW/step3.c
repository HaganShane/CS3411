...
void extractFiles(int argc, char **argv) {
    int extractFile, data, tarName, size, archivedFile, count;
    ...
    count = archiveFile.file_size;
    printf("%d", archiveFile.file_size);
    archivedFile = read(tarName, &archiveFile.file_name, sizeof(archiveFile));
